...
void wyswietl_wynik(float d, float *x1r, float *x2r, float *x1u, float *x2u, float *sr, float *su, float *rr, float *ru, float *ilr, float *ilu, float *irr, float *iru)
{
	...
	{*/
	printf("\n TEST=%g",*x1r);
	if (*x1r != false2 || *x2r != false2)
	{

		printf("\nx1=");
		/*if (*x1r == false2&&*x1u == false2)
		{
			formatuj_l_zsp(false2, false2);
		}
		if (*x1r == false2&&*x1u != false2)
		{
			formatuj_l_zsp(false2, *x1u);
		}
		if (*x1r != false2&&*x1u == false2)
		{
			formatuj_l_zsp(*x1r, false2);
		}
		if (*x1r != false2&&*x1u != false2)*/
		{
	...
	float x1r = false2,
		...
		x2u = false2,
		d = false2,
		sr = false2, su = false2, rr = false2, ru = false2, ilr = false2, ilu = false2, irr = false2, iru = false2;
